...
import commentsStyles from '../comments-visual.module.css';
...
const CommentsVisual: React.FC = () => {
  return (
    <div 
      ...
      className={commentsStyles.root}
      role="img"
    >
      {/* Left side comment */}
      <div aria-hidden="true" className={commentStyles.comment} data-side="left">
        <div className={commentStyles.bubble}>
      ...
      <div aria-hidden="true" className={commentStyles.comment} data-side="right">
        <div className={commentStyles.bubble}>
          <div 
            className={`${cursorStyles.cursor} ${commentsStyles.cursor}`}
            data-animate="false"
            data-color="blue-600"
            data-reverse="false"
            style={{
          ...
          >
            <div className={cursorStyles.cursorWrapper}>
            ...
            <div className={cursorStyles.cursorName} style={{ background: 'var(--ds-blue-600)' }}>Pranathi</div>
          </div>
      ...
      <div aria-hidden="true" className={commentStyles.comment} data-side="left">
        <div className={commentStyles.bubble}>
          ...
          >
            ...
            <div className={cursorStyles.cursorName} style={{ background: 'var(--ds-red-700)' }}>Rauno</div>
          </div>
        </div>
      </div>
      
      {/* Active right side comment with cursor and caret */}
      <div aria-hidden="true" className={commentStyles.comment} data-active="true" data-side="right">
        <div className={commentStyles.bubble}>
          This looks great!
          <div 
            className={`${cursorStyles.cursor} ${commentsStyles.cursor}`}
          ...
          <div aria-hidden="true" className={commentStyles.caret}></div>
          <div className={`stack_stack__iZkUS stack ${commentStyles.send}`} data-version="v1" style={{
            '--stack-flex': 'initial',
